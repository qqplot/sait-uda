...
_base_ = [
    ...
    '../_base_/datasets/uda_flatHR_to_fishHR_384x384.py',    
...
data = dict(
    train=dict(
        ...
        rare_class_sampling=dict(
            min_pixels=1000, class_temp=0.01, min_crop_ratio=2.0),
...
uda = dict(
    ...
    mask_generator=dict(
        type='block', mask_ratio=0.7, mask_block_size=16, _delete_=True))
...
exp = 'low'
name_dataset = 'uda_flatHR_to_fishHR_384x384' 
