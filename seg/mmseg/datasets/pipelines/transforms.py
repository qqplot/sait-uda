...
class SaltAndPepperNoise(object):
    def __init__(self, noise_rate=50):
    ...
    def __call__(self, results):
        ...
        noise_mask =  np.random.randint(0, self.noise_rate+1, size = (img.shape[0], img.shape[1]), dtype=int)
    ...
    def __repr__(self):
        repr_str = self.__class__.__name__
        repr_str += f'(noise_rate={self.noise_rate})'
        return repr_str
